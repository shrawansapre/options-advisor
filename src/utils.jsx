...
export function formatTradeAsMarkdown(trade, marketContext, analysedAt) {
  ...
  const lines = [
    ...
    `> Options Brief analysis${dateStr ? ` · ${dateStr}` : ""} — educational purposes only, not financial advice`,
    "",
  ...
  lines.push(
    "",
    "---",
    "*Generated by [Options Brief](https://options-advisor-sepia.vercel.app) — educational purposes only, not financial advice.*",
    "",
